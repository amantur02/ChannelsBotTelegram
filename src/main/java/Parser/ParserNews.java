...
public class ParserNews {
    ...
    public static void main(String[] args) throws IOException {
        ...
        parserNews.articleList = new ArrayList<>();//Это главный Лист
        ...
        for (int i = 1; i < nameList.size(); i++) {
            parserNews.articleList.add(new Article(nameList.get(i),numberList.get(i),linkList.get(i),descriptionList.get(i)));
        }
        parserNews.articleList.forEach(System.out :: println);
